...
var MonsterFight = (function () {
  function MonsterFight() {
    ...
    this.monstersList = [{ name: "Bob", health: 10 }, { name: "Ted", health: 10 }];
    this.keyPhrase;
    this.monsterHealth;
    ...
    TA.twitch.chat.on('say', function (data) {
      ...
      if (data.message == "!monsterfight" && !_this.fightingMonster) {
        $("#monster").fadeIn();
        _this.startFight();
      } else {
        _this.spamAttack(data.message);
      }
    });
  }
  ...
  _createClass(MonsterFight, [{
    key: "spamAttack",
    value: function spamAttack(message) {
      console.log(message);
    ...
    value: function startFight() {
      ...
      $.get("http://metaphorpsum.com/sentences/1").done(function (data) {
        ...
        _this2.monster = _this2.monstersList[0];
        _this2.monsterHealth = _this2.monster.health;
        _this2.keyPhrase = data;
        _this2.fightingMonster = true;
      });
    }
  }, {
    key: "newKeyPhrase",
